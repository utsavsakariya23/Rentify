        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    ...
                    <p class="text-dark mb-1"><i class="fas fa-envelope me-2"></i> support@easyrental.com</p>
                    <p class="text-dark mb-1"><i class="fas fa-phone me-2"></i> +94 11 234 5678</p>
                    <p class="text-dark"><i class="fas fa-map-marker-alt me-2"></i> Colombo, Sri Lanka</p>
                </div>
            </div>
