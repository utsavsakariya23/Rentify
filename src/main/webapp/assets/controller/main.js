...
$("#loginBtn").click(function (e) {
    ...
    if (username === "user" && password === "1234") {
        ...
        // Update UI if function exists (from footer)
        ...
        if (role === "Admin") {
            window.location.href = "assets/admin/dashboard.jsp"; // Assuming JSP exists
        } else {
            window.location.href = baseUrl + "home";
        }
    } else {
        // Legacy server check or error
         $.ajax({
            ...
            success: function (resp) {
                ...
                if (role === "Admin") window.location.href = "assets/admin/dashboard.html";
                else window.location.href = baseUrl + "home";
            },
            error: function() {
